# Generated by Django 5.0.6 on 2024-07-01 03:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favicon', models.FileField(upload_to=lernspiel_server.models.site.Site._calc_file_path, verbose_name='Website Icon')),
                ...
                ('header_fg', models.CharField(default='white', max_length=100, verbose_name='Header Foreground')),
                ('header_link', models.CharField(default='crimson', max_length=20, verbose_name='Header Link Color')),
                ('main_bg', models.CharField(default='white', max_length=100, verbose_name='Main Background')),
                ('main_fg', models.CharField(default='rgb(10, 10, 10)', max_length=100, verbose_name='Main Foreground')),
                ('main_link', models.CharField(default='crimson', max_length=20, verbose_name='Main Link Color')),
                ('footer_bg', models.CharField(default='rgb(25, 25, 25)', max_length=100, verbose_name='Footer Background')),
                ('footer_fg', models.CharField(default='lightgrey', max_length=100, verbose_name='Footer Foreground')),
                ('footer_link', models.CharField(default='lightgrey', max_length=20, verbose_name='Footer Link Color')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [models.Index(fields=['content_type', 'object_id', 'file_name'], name='lernspiel_s_content_c7a840_idx'), models.Index(fields=['content_type', 'object_id', 'source_type', 'position'], name='lernspiel_s_content_f8146f_idx')],
            },
        ),
    ]
